...
if($_POST["submit"]){
	...
	$update= "UPDATE trainer SET fullName='$fullname', password='$password', contact='$contactno', address='$address', experience='$experience' WHERE id = '$val'";
	$conn->exec($update);
				...
				<div class="col-md-6 offset-3 bg-light" style="border: 1px solid white; border-radius: 10px;">
					...
					<form method="post"  >
						...
						<div class="form-group">
							...
							<input type="text" name="experience" class="form-control" required placeholder="experience" value="<?php echo $val['experience']; ?>">
						</div>
