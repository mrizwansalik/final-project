...
if(isset($_POST['submit'])){
	$mysql = "INSERT INTO trainer (fullName, username, email, password, contact, address, experience) VALUES ('$fullname', '$username', '$email', '$password', '$contactno', '$address', '$experience')";
